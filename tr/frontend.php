...
return [
    ...
    //qazw
    'noBlocks' => 'Blok bitti',
'noBlocks2' => 'Bütün bloklar kullanıldı',
'fr' => 'Arkadaşlar',
'frLoad' => 'Arkadaş listesi yükleniyor',
'frLogin' => 'Arkadaş listesi için önce giriş yap',
'frEmpty' => 'Arkadaş listesi boş',
    'frPriv' => 'Özel',
'frIn' => 'Zaten içerde!',
'frChat' => 'Sohbeti aç',
'frRel' => 'Yenile',
'frMsgTo' => '{name} kişisine mesaj',
'frInv' => 'Oda daveti gönder',
'frInvTo' => '{room}\'a katılmak için davet',
'frInvIn' => 'Zaten içeridesin!',
'frInvBy' => '{user} tarafından',
'frOn' => 'ÇEVRİMİÇİ',
'frOff' => 'ÇEVRİMDIŞI',
'frNewChatH' => '{name} ile sohbet geçmişinin başlangıcı.',
